...
{
  {
    ...
    Homing_B.DataTypeConversion = Homing_B.original;

    /* Gain: '<Root>/Gain' */
    Homing_B.Gain = Homing_cal->Gain_Gain * Homing_B.DataTypeConversion;

    /* Sum: '<Root>/Subtract' incorporates:
     *  Constant: '<Root>/Constant'
     */
    Homing_B.Subtract = Homing_B.Gain + Homing_cal->Constant_Value;

    /* Sum: '<Root>/Subtract1' incorporates:
     *  Constant: '<Root>/zero offset'
     */
    Homing_B.linPos_m = Homing_B.Subtract - Homing_cal->zerooffset_Value;
