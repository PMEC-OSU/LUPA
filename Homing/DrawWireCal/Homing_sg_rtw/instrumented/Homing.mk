...
## 
## Makefile     : Homing.mk
## Generated on : Mon Jul 01 10:13:04 2024
...
START_DIR                 = C:/Software/LUPA/Homing/DrawWireCal
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
SRCS = $(START_DIR)/Homing_sg_rtw/Homing.cpp $(START_DIR)/Homing_sg_rtw/Homing_cal.cpp $(START_DIR)/Homing_sg_rtw/slrealtime_datatype_ground.cpp $(START_DIR)/ecat_config_xml_0.cpp $(START_DIR)/Homing_sg_rtw/rte_Homing_parameters.cpp $(START_DIR)/Homing_sg_rtw/main.cpp $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/mex/slrtEcatUtils.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = Homing.o Homing_cal.o slrealtime_datatype_ground.o ecat_config_xml_0.o rte_Homing_parameters.o main.o slrtEcatUtils.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
Homing_cal.o : $(START_DIR)/Homing_sg_rtw/Homing_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
rte_Homing_parameters.o : $(START_DIR)/Homing_sg_rtw/rte_Homing_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
