...
% Design input
if MOGA == 0
    design = [357379.6343	4.372520506	1.180771453	1.894816095	0.2497337928	-0.2836185032];
    
    inputs.InletPressure    = design(1);        
    inputs.CylLength        = design(2);
    inputs.CylDiam          = design(3);
    inputs.PressureRatio    = design(4);
